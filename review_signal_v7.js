...
const dataGetter = (() => {
    ...
    const outcomes = [].slice
        ...
        .map(e => {
            ...
            const subtitleText = e.querySelector('._af23');
            if (subtitleText == null) {
                throw new Error('No SubtitleText found');
            }
            if (isSubtitle) {

                subtitle = subtitleText.innerText.split(', ')[0];
                subSectionLabel = subtitleText.innerText.split(', ')[1];
